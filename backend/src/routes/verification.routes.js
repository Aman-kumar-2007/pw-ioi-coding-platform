...
router.post(
    ...
    async (req, res) => {
        try {
            ...
            // Check About/Summary section
            const verified =
                containsLeetCodeVerificationCode(
...
router.post(
    ...
    async (req, res) => {
        try {
            ...
            if (
                ...
                return res.json({
                    ...
                    profileUrl:
                        account.profile_url,
                    message:
                        "GFG account is already verified.",
                })
            }
            ...
            // Check profile for verification code
            const verified =
...
// =====================================================
// COMBINED CODING ACTIVITY
// =====================================================

// Used by CodingHeatmap
router.get(
    "/activity",
    requireAuth,
    async (req, res) => {
